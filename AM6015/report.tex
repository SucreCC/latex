...
\subsubsection{Stage 1 -- The M-P model}
...
\subsubsection{Stage 2 -- Hebb learning rules and Delta learning rules}
...
\subsubsection{Stage 3 -- Mark I perceptron}
...
\subsubsection{Stage 4 -- Hopfield neural network model}
...
\subsubsection{Stage 5 -- Boltzmann machine}
