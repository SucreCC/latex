...
% Despite the big efforts that particularly the private sector has made to develop cutting-edge AI technologies [10, 11], the incorporation of AI systems in healthcare has been slower than hoped [12–14].

% The advancement of certain theories and the enhancement of computer computing power have led to rapid development 
% in Artificial Intelligence (AI) in the 21st century. This evolution has spurred high expectations and attracted 
% significant investments, especially in the medical and healthcare sectors (Figure 1.1 and Figure 1.2). 
% Proponents of Healthcare AI (HCAI) have promised that the technology will enhance the accuracy of screening and 
% diagnosis, expand the availability of care in remote regions, and free up physicians' time, allowing for more patient
% engagement \cite{frostPublicViewsEthical2022}. However, the potential for AI to exacerbate health disparities through 
% modeling biases has raised notable ethical concerns. These concerns include issues related to privacy and data ownership, 
% the risk of harm from biased systems, and the absence of human oversight \cite{onianiAdoptingExpandingEthical2023, 
% katiraiEthicsAdvancingArtificial2023}. This paper discusses how these issues have arisen and explores potential solutions.
